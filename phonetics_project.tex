...
In a recent paper, Sande and Hedding (2017) argue that Amharic, a Semitic language spoken in Ethiopia, provides evidence to support a particular prediction of Moraic Theory. Specifically, they point to two phonological processes in the language---reduplication and stress assignment---which demonstrate that geminate codas are underlyingly moraic, while singleton codas are not. They make two central claims: certain reduplication processes only target words with geminates, and syllables closed by a geminate are always stressed. They use this phonological data to hypothesize that only syllables with geminate codas are heavy in the language, confirming a typological prediction made by Moraic Theory.

The aim of the present paper is to test the hypothesis of Sande and Hedding, using phonetic analysis to test their central claims. The results of that analysis clearly confirm that all test words that underwent reduplication had geminate consonants. The results don't clearly support, however, the position that all syllables closed by a geminate. Data was gathered on three known cross-linguistic correlates of stress---duration, pitch, and intensity. None of these factors could consistently predict where stress occurred.
